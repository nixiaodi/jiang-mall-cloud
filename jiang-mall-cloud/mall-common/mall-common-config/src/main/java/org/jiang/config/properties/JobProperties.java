...
public class JobProperties {
    ...
    public class JobTask {
        ...
        public class JobCoreProperties {
            ...
            /**
             * 分片序列号和参数用等号隔开，多个键值对用逗号分开，分片序列号从0开始，不可大于或等于作业分片总数如: 0=a,1=b,2=c
             */
            ...
            /**
             * 是否开始任务执行失效转移，开启表示如果作业在一次执行中途宕机，允许将该次未完成的任务在另一作业节点上补偿执行
             */
            ...
            /**
             * 配置JobProperties定义的枚举,控制Elastic-Job的实现细节 JOB_EXCEPTION_HANDLER用于扩展异常处理类 EXECUTOR_SERVICE_HANDLER用于扩展作业处理线程池类
             */
