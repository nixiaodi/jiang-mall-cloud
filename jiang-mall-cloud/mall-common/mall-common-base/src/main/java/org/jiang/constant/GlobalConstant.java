...
public class GlobalConstant {
    ...
    public static final String ROOT_PREFIX = "jiang";
     ...
     * zookeeper
     */
    public static final String ZK_REGISTRY_SERVICE_ROOT_PATH = "/jiang/registry/service";
    public static final String ZK_REGISTRY_ID_ROOT_PATH = "/jiang/registry/id";
    public static final String ZK_REGISTRY_PRODUCER_ROOT_PATH = "/jiang/registry/producer";
    public static final String ZK_REGISTRY_CONSUMER_ROOT_PATH = "/jiang/registry/consumer";
    public static final String ZK_REGISTRY_SEQ = "/jiang/seq";
    ...
    public static final class Sys {
         ...
         */
        public static final String DEFAULT_FILE_PATH = "jiang/file/";
